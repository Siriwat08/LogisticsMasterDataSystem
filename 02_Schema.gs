 ...
 *   - [FIX] สรุป_Shipment: ชื่อคอลัมน์ถูกต้องตามชีตจริง
 *   - [FIX] สรุป_เจ้าของสินค้า: ชื่อคอลัมน์ถูกต้องตามชีตจริง
 *   - [FIX] MAPS_CACHE: เพิ่ม province[8] และ district[9]
 *   - [FIX] validateSheetHeaders: เพิ่ม wrongOrder + normalize
 *   - [ADD] validateSchemaConsistency()
 * ===================================================
 */
...
const SCHEMA = Object.freeze({
   ...
   */
  'SYS_TH_GEO': [
    'รหัสไปรษณีย์', // [0] TH_GEO_IDX.POSTCODE
    'แขวง/ตำบล',    // [1] TH_GEO_IDX.SUB_DISTRICT
    'เขต/อำเภอ',    // [2] TH_GEO_IDX.DISTRICT
    'จังหวัด',      // [3] TH_GEO_IDX.PROVINCE
    'หมายเหตุ',     // [4] TH_GEO_IDX.NOTE
  ],
